...
class TicTacToe():
    ...
    def _draw_char(self, x, y, player):
        ...
        img = pygame.transform.scale(img, (self.cell_size*0.8, self.cell_size*0.8))
        screen.blit(img, (x * self.cell_size+self.cell_size*0.099, y * self.cell_size+self.cell_size*0.099, self.cell_size, self.cell_size))
    ...
    def _pattern_strike(self, start_point, end_point, line_type):
        ...
        # for the diagonal winning pattern
